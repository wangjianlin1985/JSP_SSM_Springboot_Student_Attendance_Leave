    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>Teacher/frontlist">老师查询</a></li>
                <li><a href="<%=basePath %>Teacher/teacher_frontAdd.jsp">老师注册</a></li> <!--
                <li><a href="<%=basePath %>LeaveInfo/frontlist">请假</a></li>
                <li><a href="<%=basePath %>Course/frontlist">课程</a></li>
                <li><a href="<%=basePath %>Attendance/frontlist">考勤</a></li>
                <li><a href="<%=basePath %>AttendResult/frontlist">考勤结果</a></li>-->
             ...
             <ul class="nav navbar-nav navbar-right">
             	<%
				    ...
				    if(user_name==null){
	  			%> 
	  			<li><a href="<%=basePath %>Student/student_frontAdd.jsp"><i class="fa fa-sign-in"></i>&nbsp;&nbsp;学生注册</a></li> 
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        <li><a href="<%=basePath %>Course/studentFrontlist"><span class="glyphicon glyphicon-screenshot"></span>&nbsp;&nbsp;我的课程表</a></li>
                        <li><a href="<%=basePath %>LeaveInfo/leaveInfo_stuFrontAdd.jsp"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;我要请假</a></li>
                        <li><a href="<%=basePath %>LeaveInfo/stuFrontlist"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我的请假信息</a></li>
                        <li><a href="<%=basePath %>Attendance/stuFrontlist"><span class="glyphicon glyphicon-credit-card"></span>&nbsp;&nbsp;我的出勤</a></li>
                        <li><a href="<%=basePath %>Student/student_frontModify.jsp?studentNo=<%=session.getAttribute("user_name") %>"><span class="glyphicon glyphicon-heart"></span>&nbsp;&nbsp;修改个人信息</a></li>
                    </ul>
                </li>
